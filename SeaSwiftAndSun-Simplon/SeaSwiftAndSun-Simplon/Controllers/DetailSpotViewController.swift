...
class DetailSpotViewController: UIViewController {
    ...
    private func setUpSpotDetails(spot: Spot) {
        ...
        let contactDetails: [(icon: String, detail: String)] = [
            ("Localisation", spot.fields.destinationStateCountry),
            ("Site", spot.fields.magicSeaweedLink)
        ]
...
class LineView: UIView {
    ...
    func setUp() {
        let clockImageView: UIImageView = UIImageView(image: UIImage(named: "Vector"))
